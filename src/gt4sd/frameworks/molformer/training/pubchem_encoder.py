...
class Encoder:
    ...
    def process_text(self, text):
        ...
        for mol in text:
            ...
            if "\n" in mol["text"]:
                logger.info("carriage return in mol")
        ...
        # logger.info('before Cache size  {} {} {} {}'.format(len(self.b0_cache), len(self.b1_cache), len(self.b2_cache), len(self.b3_cache)))
        ...
        if len(self.bucket0) < self.b0_max and len(self.b0_cache) > 0:
            ...
            # logger.info('0 type {}'.format(type(self.b0_cache)))
        else:
            outbucket0 = [self.bucket0.pop() for item in range(len(self.bucket0))]
    ...
    def mask_tokens(self, inputs, special_tokens_mask=None):
        ...
        # logger.info(special_tokens_mask.size())
