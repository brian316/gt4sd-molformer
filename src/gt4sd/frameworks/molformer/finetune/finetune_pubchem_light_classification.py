...
class LightningModule(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        if (
            ...
            ] = tensorboard_logs[self.hparams.measure_name + "_valid_rocauc"]
            self.min_loss[
                self.hparams.measure_name + "max_test_rocauc"
            ] = tensorboard_logs[self.hparams.measure_name + "_test_rocauc"]
        ...
        tensorboard_logs[
            self.hparams.measure_name + "_max_test_rocauc"
        ] = self.min_loss[self.hparams.measure_name + "max_test_rocauc"]
        tensorboard_logs[
            self.hparams.measure_name + "_max_valid_rocauc"
        ] = self.min_loss[self.hparams.measure_name + "max_valid_rocauc"]
        ...
        append_to_file(
            os.path.join(
                self.hparams.results_dir, "results_" + str(self.hparams.run_id) + ".csv"
            ),
